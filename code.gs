/*******************************************************
 * =========================================================
 * APPLE COVERAGE DASHBOARD - CORE BUSINESS ENGINE
 * 
...
// ============================================================
// LOAD DASHBOARD - PUBLIC (CORE BUSINESS ENGINE)
// ============================================================
...
function loadDashboard() {
    ...
    if (cached) {
        try {
            ...
            if (CONFIG.DEBUG) {
                debugLog("[loadDashboard] Cache parse error: " + e.toString());
                debugLog("[loadDashboard] Stack: " + e.stack);
            }
        }
    }
